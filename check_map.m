function [complete, traj, distance] = check_map(plan, youbot_pos_plan_x, youbot_pos_plan_y, distance)
                ...
                for a = -1:1
                    for b = -1:1
                        ...
                        if free
							...
							[find, traj] = trajectory(plan, youbot_pos_plan_x,youbot_pos_plan_y, next_pos_x, next_pos_y);
							if find
								complete = false;
								L = length(traj);
								if L/10 <= distance 
									...
									tab_traj = [tab_traj, traj];
									tab_lenght = [tab_lenght, L];
								end
							end
                        end
                    end
